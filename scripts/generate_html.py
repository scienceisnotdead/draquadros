...
#    for i, artwork in enumerate(artwork_data):
 #       print(f"{i + 1}. {artwork['name']}")
    ...
    # Updated HTML structure for the masonry grid
    html_content = f"""
    <!DOCTYPE html>
    <html lang="en">
    ...
    <head>
        ...
        <title>Clínica Dental de la Doctora Quadros Art Gallery</title>
    ...
    <header>
        ...
        <img src="draquadros-logo.svg" alt="Gallery Logo" width="150">
